...
> 同时，从 2024 年 1 月 1 日起，将开始并行提供其支持 .NET 的发行版本，新的 .NET 发行版不仅保留原功能，而且还可以支持新的 .NET 独有特性（如特性原 Java 版获取某些链接导致无法正常读取文件目标大小、403 错误等）
...
| --- | --- | --- | --- |
| 最新版本（Java，1.1.2） | √ 是 | √ 是 | 2040/01/10 |
| 最新版本（.NET，预览） | √ 是 | = 并行 | 2034/01/01 |
| 1.1 | √ 是 | × 否 | 2029/01/01 |
| 1.0 | √ 是 | × 否 | 2029/01/01 |
